...
namespace Encore\OrgRbac\Form\Concerns;

use Encore\Admin\Form\Field;
use Encore\OrgRbac\Form\Field\HasMany;
use Encore\OrgRbac\Form\Field\Image;
use Encore\OrgRbac\Form\Field\SecondSelect;
use Encore\OrgRbac\Form\Field\Select;
 ...
 * @method SecondSelect         secondSelect($column,$label = '')
 ...
 * @method HasMany              hasMany($relationName, $label = '', $callback)
 * @method HasMany              morphMany($relationName, $label = '', $callback)
...
trait HasFields
{
    ...
    public static $availableFields = [
        ...
        'select'         => Select::class,
        'secondSelect'   => SecondSelect::class,
